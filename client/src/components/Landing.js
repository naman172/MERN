        ...
        return (
           <div className={styles.body}>
                    ...
                    <svg className={styles.curve} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                            <path fill="rgba(245,245,245)" fillOpacity="1" d="M0,96L60,90.7C120,85,240,75,360,106.7C480,139,600,213,720,229.3C840,245,960,203,1080,160C1200,117,1320,75,1380,53.3L1440,32L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
                    </svg>
